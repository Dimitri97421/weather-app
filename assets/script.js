window.onload = function() {
    document.getElementById('city').value = "Paris"; // Définit Paris comme ville par défaut
...
async function getWeather() {
    ...
    if (!city) {
        document.getElementById('weatherInfo').innerText = "Veuillez entrer le nom d'une ville.";
        return;
    }
    ...
    try {
        ...
        // If time is after 18:00 and the weather code is 0 or 1, change to night image
        if (currentHour >= 18 || currentHour < 6) {
            if (weatherCodes[0] === 0) {
                todaySkyImage = "moon.png"; // Image of clear night
            } else if (weatherCodes[0] === 1 || weatherCodes[0] === 2) {
                todaySkyImage = "night-mode.png"; // Image of cloudy night
            }
        }
        ...
        document.getElementById('city').value = ""; // Réinitialise l'input après la recherche
